...
namespace Vue.Core
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("ApiRead", policy => policy.Requirements.Add(new ApiRequirement(Enums.ApiPolicy.Read)));
                options.AddPolicy("ApiWrite", policy => policy.Requirements.Add(new ApiRequirement(Enums.ApiPolicy.Write)));
                options.AddPolicy("ApiDelete", policy => policy.Requirements.Add(new ApiRequirement(Enums.ApiPolicy.Delete)));
                options.AddPolicy("ApiPrint", policy => policy.Requirements.Add(new ApiRequirement(Enums.ApiPolicy.Print)));
            });
